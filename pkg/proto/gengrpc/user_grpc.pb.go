...
type UserServiceClient interface {
	...
	GetOne(ctx context.Context, in *GetOneUserRequest, opts ...grpc.CallOption) (*GetOneUserResponse, error)
}
...
func (c *userServiceClient) GetOne(ctx context.Context, in *GetOneUserRequest, opts ...grpc.CallOption) (*GetOneUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	GetOne(context.Context, *GetOneUserRequest) (*GetOneUserResponse, error)
...
func (UnimplementedUserServiceServer) GetOne(context.Context, *GetOneUserRequest) (*GetOneUserResponse, error) {
...
func _UserService_GetOne_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetOne(ctx, req.(*GetOneUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
